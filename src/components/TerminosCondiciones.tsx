// src/components/TerminosCondiciones.tsx
import Categorias from '@/public/categorias.png';
import Image from 'next/image';

export default function TerminosCondiciones() {
  return (
    <section className="p-8 md:p-12 bg-white flex flex-col md:flex-row justify-between items-start text-gray-600">
      {/* Columna izquierda con la imagen de categorías */}
      <div className=" md:w-[40%]">
        <Image
          ...
          width={242}
          height={242}
          className="mr-4 my-96 ml-60 "
        />
      </div>

      {/* Columna derecha con los términos y condiciones en dos columnas */}
      <div className="md:w-[60%] grid grid-cols-1 md:grid-cols-2 gap-6 mr-40">
        <div className="pr-6">
          <h1 className="text-3xl font-bold mb-4">Modelo de Términos y Condiciones:</h1>
