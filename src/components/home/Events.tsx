    ...
    return (
        <section className="py-24 bg-gradient-to-b from-white to-gray-50 relative">
            <div className="container mx-auto px-4 md:px-6">
                ...
                >
                    <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-verde-goodkidz mb-6">
                        AL COMPÁS DE LAS ACCIONES
                    </h2>
                    <div className="w-80 h-1 bg-gradient-to-r from-verde-goodkidz to-verde-goodkidz/50 rounded-full mx-auto"></div>
                </motion.div>
