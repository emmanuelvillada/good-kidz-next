            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[500px] lg:min-h-[650px]">
                    ...
                    <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}
                        className="relative hidden lg:flex justify-center items-center xl:w-[900px] xl:h-[500px] xl:bottom-[-180px] xl:left-[-300px] lg:w-[700px] lg:h-[500px] lg:bottom-[-130px] lg:left-[-100px]" >
