        ...
        <section id="events" className="py-24 bg-gradient-to-b from-gray-50 to-white">
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <CarouselPrevious className="hidden md:flex -left-12 hover:bg-verde-goodkidz hover:text-white" />
                    <CarouselNext className="hidden md:flex -right-12 hover:bg-verde-goodkidz hover:text-white" />
                </Carousel>
            </div>
        </section>
    )
